...
# agar halaman wishlist 
# hanya dapat diakses oleh pengguna yang sudah login (terautentikasi)
...
# menghasilkan formulir registrasi secara otomatis 
...
def logout_user(request):
    # menambahkan mekanisme penghapusan cookie last_login saat pengguna melakukan logout
    logout(request) 
